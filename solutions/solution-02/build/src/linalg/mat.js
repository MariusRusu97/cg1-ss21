...
class Matrix {
     ...
     */
    add(m) {
        return new Matrix(this.x00 + m.x00, this.x01 + m.x01, this.x02 + m.x02, this.x03 + m.x03, this.x10 + m.x10, this.x11 + m.x11, this.x12 + m.x12, this.x13 + m.x13, this.x20 + m.x20, this.x21 + m.x21, this.x22 + m.x22, this.x23 + m.x23, this.x30 + m.x30, this.x31 + m.x31, this.x32 + m.x32, this.x33 + m.x33);
    }
    /**
    ...
    mul(m) {
        ...
        return new Matrix(this.x00 * m.x00 + this.x01 * m.x10 + this.x02 * m.x20 + this.x03 * m.x30, this.x00 * m.x01 + this.x01 * m.x11 + this.x02 * m.x21 + this.x03 * m.x31, this.x00 * m.x02 + this.x01 * m.x12 + this.x02 * m.x22 + this.x03 * m.x32, this.x00 * m.x03 + this.x01 * m.x13 + this.x02 * m.x23 + this.x03 * m.x33, this.x10 * m.x00 + this.x11 * m.x10 + this.x12 * m.x20 + this.x13 * m.x30, this.x10 * m.x01 + this.x11 * m.x11 + this.x12 * m.x21 + this.x13 * m.x31, this.x10 * m.x02 + this.x11 * m.x12 + this.x12 * m.x22 + this.x13 * m.x32, this.x10 * m.x03 + this.x11 * m.x13 + this.x12 * m.x23 + this.x13 * m.x33, this.x20 * m.x00 + this.x21 * m.x10 + this.x22 * m.x20 + this.x23 * m.x30, this.x20 * m.x01 + this.x21 * m.x11 + this.x22 * m.x21 + this.x23 * m.x31, this.x20 * m.x02 + this.x21 * m.x12 + this.x22 * m.x22 + this.x23 * m.x32, this.x20 * m.x03 + this.x21 * m.x13 + this.x22 * m.x23 + this.x23 * m.x33, this.x30 * m.x00 + this.x31 * m.x10 + this.x32 * m.x20 + this.x33 * m.x30, this.x30 * m.x01 + this.x31 * m.x11 + this.x32 * m.x21 + this.x33 * m.x31, this.x30 * m.x02 + this.x31 * m.x12 + this.x32 * m.x22 + this.x33 * m.x32, this.x30 * m.x03 + this.x31 * m.x13 + this.x32 * m.x23 + this.x33 * m.x33);
    }
    /**
     ...
     */
    scale(s) {
        return new Matrix(this.x00 * s, this.x01 * s, this.x02 * s, this.x03 * s, this.x10 * s, this.x11 * s, this.x12 * s, this.x13 * s, this.x20 * s, this.x21 * s, this.x22 * s, this.x23 * s, this.x30 * s, this.x31 * s, this.x32 * s, this.x33 * s);
    }
    /**
